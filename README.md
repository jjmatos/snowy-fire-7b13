...
```bash
npm create cloudflare@latest -- --template=cloudflare/templates/snowy-fire-7b13
```

A live public deployment of this template is available at [https://snowy-fire-7b13.templates.workers.dev](https://snowy-fire-7b13.templates.workers.dev)
